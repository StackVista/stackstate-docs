...
* [Amazon EKS](k8s-quick-start-guide.md#amazon-eks)
* [Azure AKS](k8s-quick-start-guide.md#azure-aks)
* [Google GKE](k8s-quick-start-guide.md#google-gke)
* [Kubernetes](k8s-quick-start-guide.md#kubernetes)
* [KOPS](k8s-quick-start-guide.md#kops)
* [OpenShift](k8s-quick-start-guide.md#openshift)
* [Self-hosted](k8s-quick-start-guide.md#self-hosted)
...
{% hint style="warning" %}
Before you begin, check the [prerequisites for Kubernetes](k8s-quick-start-guide.md#prerequisites-for-kubernetes).
{% endhint %}
...
{% hint style="warning" %}
Before you begin, check the [prerequisites for Kubernetes](k8s-quick-start-guide.md#prerequisites-for-openshift).
{% endhint %}
...
{% hint style="warning" %}
Before you begin, check the [prerequisites for Kubernetes](k8s-quick-start-guide.md#prerequisites-for-amazon-eks).
{% endhint %}
