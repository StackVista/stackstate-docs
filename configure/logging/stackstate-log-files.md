...
Go to the [documentation for the latest StackState release](https://docs.stackstate.com/configure/logging/stackstate-log-files).
{% endhint %}
...
{% hint style="info" %}
Note that logs stored on pods will be regularly removed. For long term access to logs, it is advised that you set up [log aggregation](stackstate-log-files.md#log-aggregation) for your Kubernetes cluster.
{% endhint %}
