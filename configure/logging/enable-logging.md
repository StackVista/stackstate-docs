...
- [State propagation and propagation functions](/configure/health_state_and_alerting/propagation.md)
- [View state configuration functions](/configure/health_state_and_alerting/view_state_configuration.md)