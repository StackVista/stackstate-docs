...
2. Use the [StackState CLI](../../setup/install-stackstate/cli-install.md) to set the logging level for the ID, for example:
...
The ID for an event handler can be found using the [StackState CLI](../../setup/install-stackstate/cli-install.md). This is the ID for an instance of an event handler function.
...
The ID for a view health state configuration can be found using the [StackState CLI](../../setup/install-stackstate/cli-install.md). This is the ID for a view's instance of a view health state configuration function.
