...
* The [`stac` CLI](/setup/cli/cli-stac.md) is required to set the logging level. It's not possible to set the logging level of a function instance using the new `sts` CLI.
{% endhint %}
