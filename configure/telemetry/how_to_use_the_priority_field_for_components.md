...
Go to the [documentation for the latest StackState release](https://docs.stackstate.com/configure/telemetry/how_to_use_the_priority_field_for_components).
{% endhint %}
...
![Edit telemetry stream](../../.gitbook/assets/v44_telstream_edit.png)
...
![Edit basic\_health](../../.gitbook/assets/v44_edit_basic_health.png)
...
![Edit packetsReceiveRate](../../.gitbook/assets/v44_edit_medium.png)
