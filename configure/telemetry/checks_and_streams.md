...
Read how to [add a telemetry stream to an element](../../use/health-state-and-alerts/add-telemetry-to-element.md) or how to [add telemetry during topology synchronization](telemetry_synchronized_topology.md).
...
Read more about [anomaly detection with baselines](../../use/health-state-and-alerts/anomaly-detection-with-baselines.md) and [baseline functions](baseline-functions.md).
