...
Let's use a Table from the non exist Database as a child, this allows us to add a critical health state on the child if a write event to this table failed.
