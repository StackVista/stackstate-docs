...
|:----------------------------------------|:------------:|:---------------:|:-------------------:|:-----------------------------|
| [trace.perspective.name](./mappings.md) |   `string`   |     **yes**     |     Any string      | RDS Database: Perspective Name|
| [service.name](./mappings.md#Trace Perspective Name)      |   `string`   |     **yes**     |     Any string      | RDS Database: Service Name            |
