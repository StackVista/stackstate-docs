...
![Distributed Trace Sample](../../.gitbook/assets/otel_distributed_trace_sample.png)
...
![Distributed Trace Parent Span](../../.gitbook/assets/otel_distributed_trace_parent_span.png)

The second interaction inside the Lambda script was with an SQS Queue

![Distributed Trace Child Span](../../.gitbook/assets/otel_distributed_trace_child_span.png)
