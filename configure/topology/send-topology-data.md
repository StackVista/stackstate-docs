...
* You can also create a **custom topology synchronization**. StackState accepts topology data in JSON format. JSON files received pass through a number of processing steps. At the end of this synchronization pipeline, StackState stores the incoming data as part of its topology, consisting of components and relations. 
