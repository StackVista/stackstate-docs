...
3. Add an email [event handler](../../use/metrics-events/send-event-notifications.md#send-event-notifications-with-event-handlers) to a view from the StackState UI.
{% endtab %}
...
* [Add an event handler](../../use/metrics-events/send-event-notifications.md#send-event-notifications-with-event-handlers)
