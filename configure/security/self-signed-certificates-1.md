...
You need to have the custom TLS certificate available. If you don't have that, you will need to [retrieve it via the browser](self-signed-certificates-1.md#retrieve-certificate-via-the-browser).
...
If you don't have the JVM installed on your computer, you can also [use a JVM docker image](self-signed-certificates-1.md#using-a-docker-jvm) instead.
