...
It is also possible to add more roles, see the page [Roles \(RBAC\)](../rbac/rbac_roles.md) and the other [RBAC documentation pages](https://github.com/StackVista/stackstate-docs/tree/6547cfc3ba954d087fd21e596d730a5d44cd0a67/configure/security/configure/security/rbac/README.md)
