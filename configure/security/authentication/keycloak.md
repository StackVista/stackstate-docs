...
5. **redirectUri** - The URI where the login callback endpoint of StackState is reachable (for Kubernetes this can be overriden but is by default populated based on the `stackstate.baseUrl` setting)
