...
| `access-view` | Access a specific view (when granted on a view) or all views (when granted on the everything subject).<br />Example: [Grant permissions to open a view](rbac_permissions.md#open-a-view). | - | ✅ | ✅ |
