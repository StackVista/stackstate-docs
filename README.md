...
With the release of StackState v4.3, StackState v4.0 reaches End of Life (EOL) and will be no longer supported. If you are running version 4.0, please upgrade StackState to a [supported version](#supported-stackstate-versions). 
