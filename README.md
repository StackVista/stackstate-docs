    ...
    <tr>
      ...
      <td style="text-align:left">
        <ul>
          ...
          <li><a href="configure/topology/component_actions.md">Create component actions</a>
          </li>
          <li><a href="configure/security/how_to_set_up_roles.md">Configure AuthN and AuthZ</a>
          </li>
