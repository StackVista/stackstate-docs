...
Select a component to display detailed information about it in the right panel **details** tab. You'll see the component's labels and other meta-data you sent.
...
Select the **myDummyApp** component to display detailed information about it in the right panel **details** tab. Find the triple dots menu in the top-right corner. There, select the **Edit template** option. This brings up the **Template Editor**.
