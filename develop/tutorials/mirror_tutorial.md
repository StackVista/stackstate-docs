...
In the **Telemetry** section, click **ADD NEW STREAM**. This opens the Stream Wizard to add a new stream. Enter **mirror sample** as the name for the stream and select the **Mirror server** datasource.
