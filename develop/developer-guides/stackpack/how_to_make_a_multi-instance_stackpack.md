...
This documentation set explains how to make a StackPack that can be installed as multiple instances in Rancher Observability. Below you can find the introduction to this topic and the steps to get a multi-instance StackPack.
