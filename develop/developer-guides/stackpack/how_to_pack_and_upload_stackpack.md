...
To upload the `.sts` file to StackState use the [StackState CLI](../../../setup/install-stackstate/cli-install.md) with the following command: `sts stackpack upload path/to/file.sts`
