...
* **aggregation** - Optional. sets the aggregation function for the metrics in StackState. See [aggregation methods](/use/health-state/add-a-health-check.md#aggregation).
