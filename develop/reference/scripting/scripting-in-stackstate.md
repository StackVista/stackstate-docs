...
Go to the [documentation for the latest StackState release](https://docs.stackstate.com/develop/reference/scripting/scripting-in-stackstate).
{% endhint %}
...
![Analytics environment](../../../.gitbook/assets/v44_analytics.png)
