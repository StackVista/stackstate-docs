...
{% hint style="info" %}
Users require the permission `execute-restricted-scripts` to execute scripts using the HTTP script API in the StackState UI analytics environment. For details, see the [analytics page permissions](/configure/security/rbac/rbac_permissions.md#analytics-page-permissions).
{% endhint %}
