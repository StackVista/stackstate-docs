...
This example returns the name of the layer for the component with id `123`. After getting the layer the [AsyncScriptResult](/develop/reference/scripting/scripting/async_script_result.md) `then` function is used to get the name of the layer.
