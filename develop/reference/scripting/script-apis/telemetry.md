...
* `.groupBy(fieldName: String)` - optional. returns grouped results from Elasticsearch. Requires `.aggregation()`. If there is no aggregation, a plain metric stream will be returned.
