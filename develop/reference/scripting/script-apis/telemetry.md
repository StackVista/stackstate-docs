...
* `start(time: Instant)` - sets the start [time](/develop/reference/scripting/script-apis/time.md) of the query, for example `-3h`.
* `end(time: Instant)` - sets the end [time](/develop/reference/scripting/script-apis/time.md) of the query, for example `-1h`.
