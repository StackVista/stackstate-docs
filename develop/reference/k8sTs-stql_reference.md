...
An STQL query consists of [component filters](k8sTs-stql_reference.md#component-filters) and [functions](k8sTs-stql_reference.md#functions). The query output is a component, or set of components, filtered from the complete topology.
...
The filters described below can be combined using the available [operators](k8sTs-stql_reference.md#operators) to achieve complex selections of components.
...
| ------------ | ------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `components` | "all"   | A component filter   | The component(s) for which the neighbors will be returned, see [component filters](k8sTs-stql_reference.md#component-filters).                                                                                                                |
