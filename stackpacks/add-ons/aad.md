...
* It is also possible to [install the AAD standalone](../../setup/install-stackstate/kubernetes_openshift/aad_standalone.md "StackState Self-Hosted only") within Kubernetes.
...
Know what the AAD is working on. [The status UI of the AAD](/setup/install-stackstate/kubernetes_openshift/aad_standalone.md#troubleshooting) provides various metrics and indicators, including details of what the AAD is currently doing.
{% endhint %}
