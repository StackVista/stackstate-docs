...
| Data | Description                                                                                                                                                                                                                           |
| :--- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Components | Nodes and interfaces. Sometimes, a SolarWinds node won't show any interfaces in the SolarWinds system. If UDT detects such a node connected to a device, a 'ghost' interface will be created in StackState to show the full topology. |
