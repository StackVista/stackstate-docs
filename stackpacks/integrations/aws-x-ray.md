...
The AWS X-Ray check is included in the [Agent V2 StackPack](agent.md). You also need to install the [AWS StackPack](aws/aws.md) to see the rest of the AWS topology and metrics.
