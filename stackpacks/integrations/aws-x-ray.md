...
1. Edit the Agent integration configuration file `/etc/stackstate-agent/conf.d/aws_xray.d/conf.yaml` to start collecting your Tomcat metrics and logs. See the sample `aws.d/conf.yaml.example` for all available configuration options.
