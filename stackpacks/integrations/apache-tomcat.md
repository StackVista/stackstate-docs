...
If you specify an alias in an `include` key that is formatted as _camel case_, it's converted to _snake case_. For example, StackState will show `MyMetricName` as `my_metric_name`.
