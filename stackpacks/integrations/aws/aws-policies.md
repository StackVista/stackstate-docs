...
By default, this KMS key gives full access to any IAM user within the account to administer the key. Modify this as necessary to meet your organization's security policies.
