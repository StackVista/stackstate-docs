...
If StackState or StackState Agent run within an AWS environment on an EC2 instance, an IAM role can be attached to the EC2 instance for authentication. When this role is available, StackState or StackState Agent can use it for authentication.
