...
Components retrieved from AWS will have an additional [action](/use/stackstate-ui/perspectives/topology-perspective.md#actions) available in the component context menu and in the right panel when the component is selected. This provides a deep link through to the relevant AWS console at the correct point.
