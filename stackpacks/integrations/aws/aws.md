...
* [OpenTelemetry](/stackpacks/integrations/aws/opentelemetry-nodejs.md) will monitor communication between your Lambda functions and AWS services it communicates with using traces.
...
Do note if you want to use [OpenTelemetry Traces](/stackpacks/integrations/aws/opentelemetry-nodejs.md) the `IncludeOpenTelemetryTracing` value needs to be set to `true`
...
* **IncludeOpenTelemetryTracing** - Default: disabled, When this is enabled then the OpenTelemetry layer will be included in your deployment allowing you to follow [these steps to use OpenTelemetry](/stackpacks/integrations/aws/opentelemetry-nodejs.md)
...
OpenTelemetry can enhance your Topology by creating and using trace. [You can follow this doc to install and use OpenTelemetry](/stackpacks/integrations/aws/opentelemetry-nodejs.md)
...
By using the StackState [OpenTelemetry Lambda Layer](/stackpacks/integrations/aws/opentelemetry-nodejs.md) you can transform your Topology as follows:

| From This                                                             | To This                                                                    | 
|-----------------------------------------------------------------------|----------------------------------------------------------------------------|
| ![Edit Lambda Layer](../../../.gitbook/assets/otel_from_original.png) | ![Edit Lambda Layer](../../../.gitbook/assets/otel_to_with_traces.png) |

You can read more on about how to [use and setup OpenTelemetry here](/stackpacks/integrations/aws/opentelemetry-nodejs.md)
