...
* **StsAccountId** - The 12-digit AWS account ID that's going to be monitored. This will be the AWS account that the IAM role can be assumed from, to perform actions on the target AWS account. Example: `0123456789012`.
...
* Kinesis Firehose: priced by the amount of data processed. Events use small amounts of data. [Firehose pricing \(aws.amazon.com\)](https://aws.amazon.com/kinesis/data-firehose/pricing/)
