...
![Windows integration](/.gitbook/assets/stackpack-agent-Windows.png)
...
To disable the Windows check, remove or rename the Agent integration configuration file, for example:

```buildoutcfg
mv Windows.d/conf.yaml Windows.d/conf.yaml.bak
```
