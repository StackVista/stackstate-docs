...
![Docker integration](/.gitbook/assets/stackpack-agent-Docker.png)
...
To disable the Docker check, remove or rename the Agent integration configuration file, for example:

```buildoutcfg
mv Docker.d/conf.yaml Docker.d/conf.yaml.bak
```
