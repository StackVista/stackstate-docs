...
![MySQL integration](/.gitbook/assets/stackpack-agent-MySQL.png)
...
To disable the MySQL check, remove or rename the Agent integration configuration file, for example:

```buildoutcfg
mv MySQL.d/conf.yaml MySQL.d/conf.yaml.bak
```
