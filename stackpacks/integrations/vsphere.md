...
3. [Restart the StackState Agent\(s\)](/setup/agent/about-stackstate-agent.md) to publish the configuration changes.
...
3. [Restart the StackState Agent\(s\)](/setup/agent/about-stackstate-agent.md) to apply the configuration changes.
