...
{% hint style="info" %}
Example Splunk health Agent check configuration file:<br />[splunk_health/conf.yaml.example \(github.com\)](https://github.com/StackVista/stackstate-agent-integrations/blob/master/splunk_health/stackstate_checks/splunk_health/data/conf.yaml.example)
{% endhint %}
