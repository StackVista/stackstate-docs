...
**If you are running [StackState Agent V2](/setup/agent/about-stackstate-agent.md)**, see the instructions on how to configure a [Splunk topology V2](splunk_topology_v2.md) check. You can also [upgrade](splunk_topology_upgrade_v1_to_v2.md) an existing Splunk topology V1 integration to use StackState Agent V2.
{% endhint %}
