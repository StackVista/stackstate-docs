...
3. Change the `name` and `identifier` for each exported item:
   ...
   * Save the export.
4. [Import](https://github.com/StackVista/stackstate-docs/tree/6702d015f71c50c68c7257b3986382d669443b98/stackpacks/setup/data-management/backup_restore/configuration_backup.md#import-configuration) the updated export file\(s\).
