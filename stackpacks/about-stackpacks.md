...
{% hint style="info" %}
Note that the lock status of configuration items will not be exported as part of a [configuration backup](/setup/data-management/backup_restore/configuration_backup.md). This will need to be set again when the configuration is imported.
{% endhint %}
