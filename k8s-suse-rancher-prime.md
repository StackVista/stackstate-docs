...
StackState server should be installed in a downstream cluster for intended for Observability. See the below picture for reference.
...
1. Navigate to the _Rancher Prime Observability_ section and select "configurations". In this section, you can add the StackState server details and connect it.
