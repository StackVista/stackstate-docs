...
Select a component or a relation to display detailed information about it in the right panel details tab - the tab will be named according tothe element type that you selected. Click **SHOW ALL PROPERTIES** to open a popup with all details of a component.
