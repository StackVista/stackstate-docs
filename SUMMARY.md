...
* [Health state and alerting](configure/health_state_and_alerting/README.md)
    * [View state configuration](configure/health_state_and_alerting/view_state_configuration.md)
    * [Configure email alerts](configure/health_state_and_alerting/configure-email-alerts.md)
    * [State propagation](configure/health_state_and_alerting/propagation.md)
    * [Event handlers](configure/health_state_and_alerting/event-handlers.mc)
