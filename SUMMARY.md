...
* [Install StackState](setup/install-stackstate/README.md)
  ...
  * [Kubernetes install](setup/install-stackstate/kubernetes_install/README.md)
    ...
    * [Custom helm install](setup/install-stackstate/kubernetes_install/image_configuration_agent.md)
    * [Custom install with helm](setup/install-stackstate/kubernetes_install/image_configuration_agent.md)
