...
* [Install StackState](setup/install-stackstate/README.md)
  ...
  * [Kubernetes install](setup/install-stackstate/kubernetes_install/README.md)
    ...
    * [Install from custom image registry](setup/install-stackstate/kubernetes_install/install-from-custom-image-registry.md)
...
* [StackState Agent](setup/agent/README.md)
  ...
  * [Migrate Agent V1 to Agent V2](setup/agent/migrate-agent-v1-to-v2/README.md)
    * [Linux](setup/agent/migrate-agent-v1-to-v2/agent-v1-to-agent-v2-linux.md)
    * [Docker](setup/agent/migrate-agent-v1-to-v2/agent-v1-to-agent-v2-docker.md)
