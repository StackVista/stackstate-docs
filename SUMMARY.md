...
* [Setup](setup/README.md)
  ...
  * [Kubernetes install](/setup/kubernetes-install/README.md)
    ...
    * [Install StackState](setup/kubernetes-install/install_stackstate.md)
  ...
  * [Linux install](/setup/linux-install/README.md)
    * [Requirements](setup/linux-install/requirements.md)
    * [Install StackState](setup/linux-install/install_stackstate.md)
    * [Install with production configuration](setup/linux-install/production-installation.md)
    * [Install with development configuration](setup/linux-install/development-installation.md)
    * [Install with POC configuration](setup/linux-install/poc-installation.md)
    * [Set up a reverse proxy](setup/linux-install/reverse_proxy.md)
    * [Set up TLS without reverse proxy](setup/linux-install/how_to_setup_tls_without_reverse_proxy.md)
