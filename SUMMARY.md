...
* [Health state and alerts](configure/health_state_and_alerting/README.md)
    * [Configure email alerts](configure/health_state_and_alerting/configure-email-alerts.md)
    * [Configure view health state reporting](configure/health_state_and_alerting/view_state_configuration.md)
    * [Event handlers](configure/health_state_and_alerting/event-handlers.md)
    * [Health state propagation](configure/health_state_and_alerting/propagation.md)
