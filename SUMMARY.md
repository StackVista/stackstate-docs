...
* [Configure](configure/README.md)
  ...
  * [Telemetry](configure/telemetry/README.md)
    ...
    * [Set priority for telemetry streams](configure/telemetry/how_to_use_the_priority_field_for_components.md)
  * [Traces](configure/traces/README/md)
    * [Set up traces](configure/traces/how_to_setup_traces.md)
    * [Trace configuration](configure/traces/configure_tracing.md)
  * [Security](configure/security/README.md)
    ...
    * [RBAC permissions](configure/security/permissions.md)
    * [RBAC roles](configure/security/how_to_set_up_roles.md)
    * [RBAC scopes](configure/security/scopes_in_rbac.md)
    * [RBAC subjects](configure/security/subject_configuration.md)
    * [Secrets management](configure/security/secrets_management.md)
    * [Set up a security backend for Linux](configure/security/how_to_set_up_a_security_backend_for_linux.md)
  ...
  * [Logging](configure/logging/README.md)
    * [Logging for checks, event handlers and functions](configure/logging/enable-logging.md)
