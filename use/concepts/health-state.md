...
Changes to a health state will generate [events](/use/events/about_events.md) that can trigger [event notifications](/use/events/event-notifications.md).
...
Existing StackPacks include StackState health checks out of the box.
...
Existing StackPacks will include StackState monitors out of the box.
...
* **Starred views** - The StackState main menu lists all Starred views together with their health state.
