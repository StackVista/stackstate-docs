...
To filter the topology using basic filters, click on the **View Filters** button on the left and select **Basic** under **Filter Topology**. 
...
To filter the topology using an STQL query, click on the **View Filters** button on the left and select **Advanced** under **Filter Topology**. 
