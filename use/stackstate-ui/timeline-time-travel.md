...
To inspect the events hover over the blue bars. A context menu will appear right above the bar that describes:

* The types of events that happened at that interval of time. By clicking on the event type a panel with those events will be displayed in the right panel.
* The number of events that happened at that interval of time. By clicking on the number of events a panel with those events will be displayed in the right panel.
