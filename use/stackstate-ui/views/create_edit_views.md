...
A saved view can be edited or deleted from either the **all views** screen, or the **View Summary** in the right panel.
...
2. **View Summary** in the right panel:
   * Open the view.
   * Select the context menu \(accessed through the triple dots\) to the right of the view name in the **View Summary** in the right panel.
