...
![Topology Perspective](../../../.gitbook/assets/v4x_topology.png)
...
![Actions](../../../.gitbook/assets/v4x_actions.png)
...
![Root cause](../../../.gitbook/assets/v4x_show_full_root_cause_tree.png)

## List mode

The components in the topology visualization can also be shown in a list instead of a graph:

![Filtering\(list format\)](../../../.gitbook/assets/v4x_list_mode.png)
