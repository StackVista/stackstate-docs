...
* Click on a component to display the [detailed component information](/use/concepts/components.md#detailed-component-information) in the right panel.
...
A list of the available actions is included in the right panel when you select a component to show its detailed information and also in the component context menu, which is displayed when you hover over a component.
...
Click on a relation to open detailed information about it in the right panel.
...
* Events filters: Filter the events shown in the **Events** list of the **View Summary** in the right panel.

Select an element to show detailed information about it in the right panel. From the right panel, click on a label to add this to the topology filter. The displayed topology will be expanded to include all components and relations with the selected label. To undo a label selection, click the back button in the browser or edit the topology filter in the view filters.
