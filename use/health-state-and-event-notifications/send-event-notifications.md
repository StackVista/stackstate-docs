...
3. Select the trigger event and event handler to run: 
   * **On event** - the type of [state change events](send-event-notifications.md#state-change-events) that should trigger the event notification or automated action.
