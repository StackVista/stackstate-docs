...
![Filtering example](/images/topology/basic_filtering.png)

The same topology selection can also be shown in list format:

![Filtering(list)](/images/topology/basic_filtering_list.png)
...
![Quick Actions](/images/quick_actions.png)
...
If you require more flexibility in selecting topology, check out our [guide to Advanced topology querying with STQL](/use/topology_selection_advanced).
