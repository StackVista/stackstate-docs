...
* [Filter Topology](#topology-filters)
* [Filter Events](#event-filters)
* [Filter Traces](#trace-filters)
...
You can use the View Filters pane to filter the events shown in the [Events Perspective](/use/views/events_perspective.md) and in the **Event** list in the view details pane on the right of the StackState UI while in the Topology Perspective. 

The following event filters are available:

| Filter | Description |
| :--- | :--- |
| **Category** | Show only events from one or more [categories](/use/views/events_perspective.md#event-category). |
...
The traces shown in the Traces Perspective can be filtered by **Tags** or **Span Types**. Read more about [filtering traces in the Traces Perspective](/use/views/traces-perspective.md#trace-filters)
