...
| Filter | Description |
| :--- | :--- |
| **Category** | Filter events by one or more [categories](/use/views/events_perspective.md@event-category) |
...
The traces shown in the Traces Perspective can be filtered by **Tags** or **Span Types**. Read more about [filtering traces in the Traces Perspective](traces-perspective.md#trace-filters)
