...
5. Event handlers associated with the view listen to the generated events and trigger any [configured alerts and actions](/use/health-state-and-alerts/add-an-alert.md).
