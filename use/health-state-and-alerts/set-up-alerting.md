...
3. Select the type of [state change events](#state-change-events) that should trigger an alert or automated action.
4. Select the event handler function that should run whenever the selected event type is generated:
...
5. Enter the required details, these will vary according to the event handler function you have selected.
6. Click **SAVE**.
