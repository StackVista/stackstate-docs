...
* **Events** -- shows the 5 most recent events that occurred for components in the view. Click **View all** to show the [event perspective](perspectives/event-perspective.md).
