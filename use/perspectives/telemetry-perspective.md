...
The Telemetry Perspective shows telemetry streams for your [view](/use/views.md) and provides an automatic dashboard. Instead of pre-defining which streams you want to see, StackState automatically delivers all the relevant information for any part of your landscape.
