...
The Topology Perspective shows components and relations in the selected [view](../views.md). Components that have one or more [checks](../../configure/telemetry/checks_and_streams.md#checks) configured will have a calculated [health state](../../configure/topology/propagation.md).
...
If one or more components have a critical state, StackState will show the related components and their states as a **Problem** in the [View Details pane](https://github.com/StackVista/stackstate-docs/tree/f363533f058f3eaa22d904a7cdfdb435b0ebca34/use/perspectives/README.md#the-view-details-pane).
