...
* [The metric chart doesn't show on the Highlights page of a component](k8sTs-metrics-troubleshooting.md#the-metric-chart-doesnt-show-on-the-highlights-page-of-a-component)
* [The metric chart doesn't show on the metrics perspective of a component](k8sTs-metrics-troubleshooting.md#the-metric-chart-doesnt-show-on-the-metrics-perspective-of-a-component)
* [The metric chart on a component remains empty ("no data")](k8sTs-metrics-troubleshooting.md#the-metric-chart-on-a-component-remains-empty-no-data)
