...
1. In the StackState UI Topology Perspective, select the component that you want to add an anomaly health check to.
   * Detailed information abou the component will be displayed in the right panel,
2. Click on the **ADD NEW HEALTH CHECK** button under **Health** in the right panel.
