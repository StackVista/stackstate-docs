...
2. Click **ADD NEW HEALTH CHECK** under **Health** in the right panel.
3. In the **Add check** dialog box, provide the following details:
   * **Name** - The health check name. Will be displayed in the StackState UI right panel **Health** section.
