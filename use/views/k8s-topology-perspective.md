...
* Select a component to display [detailed component information](../concepts/components.md#component-details) in the right panel details tab - **Component details**.
* Hover over a component to open the [component context menu](k8s-topology-perspective.md#component-context-menu).

➡️ [Learn more about components](../concepts/components.md#components)
...
* [Health state](../concepts/health-state.md) and [propagated health state](../concepts/health-state.md#element-propagated-health-state) of the component.
* [Actions](k8s-topology-perspective.md#actions) specific to the component.
* [Shortcuts](k8s-topology-perspective.md#shortcuts) specific to the component.
...
➡️ [Learn more about relations](../concepts/relations.md)
...
* Indirect relations - should relations between components be shown if these connect through other components that aren't displayed in the view. For details, see [relations](../concepts/relations.md).

The Visualization Settings are saved together with the View. For details, see the page [Visualization settings](visualization_settings.md).
