...
StackState will generate events tracking creation and changes made to problems. These are not listed in the Events perspective, but can be used to trigger [problem notifications](/use/problems/problem_notifications.md).
