...
1. Select the element that you want to assign a health check to.
   ...
   * If no telemetry stream is available on the selected element, you will need to [add a telemetry stream](../metrics-and-events/add-telemetry-to-element.md) first before you can add a health check.
