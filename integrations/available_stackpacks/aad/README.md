...
The AAD StackPack can only be installed within a [Kubernetes setup](/setup/installation/kubernetes/README.md). Please make sure that this is supported by your StackState installation.
