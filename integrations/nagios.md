...
* An API-Integration Agent must be installed on a single machine which can connect to the Nagios and to StackState. (See the [API Integration StackPack](/integrations/api-integration/) for more details)
