...
* [Welcome to the Rancher Observability docs!](README.md)
* [Rancher Observability self-hosted v5.1 docs](latest.md)
...
* [Install Rancher Observability](setup/install-stackstate/README.md)
  ...
  * [Linux](setup/install-stackstate/linux/README.md)
    ...
    * [Install Rancher Observability](setup/install-stackstate/linux/install_stackstate.md)
...
* [Upgrade Rancher Observability](setup/upgrade-stackstate/README.md)
  ...
  * [Rancher Observability release notes](setup/upgrade-stackstate/sts-release-notes.md)
* [Rancher Observability Agent](setup/agent/README.md)
  * [About Rancher Observability Agent V2](setup/agent/about-stackstate-agent.md)
...
* [Concepts](use/concepts/README.md)
  ...
  * [Rancher Observability architecture](use/concepts/stackstate_architecture.md)
* [Rancher Observability UI](use/stackstate-ui/README.md)
...
* [Integrations](stackpacks/integrations/README.md)
  ...
  * [💠 Rancher Observability Agent V2](stackpacks/integrations/agent.md)
  * [💠 AWS](stackpacks/integrations/aws/README.md)
    ...
    * [Rancher Observability/Agent IAM role: EC2](stackpacks/integrations/aws/aws-sts-ec2.md)
    * [Rancher Observability/Agent IAM role: EKS](stackpacks/integrations/aws/aws-sts-eks.md)
...
* [Developer guides](develop/developer-guides/README.md)
  * [Agent checks](develop/developer-guides/agent_check/README.md)
    ...
    * [Connect an Agent check to Rancher Observability](develop/developer-guides/agent_check/connect_agent_check_with_stackstate.md)
  * [Custom functions and scripts](develop/developer-guides/custom-functions/README.md)
    * [Rancher Observability functions](develop/developer-guides/custom-functions/functions.md)
  ...
  * [StackPack development](develop/developer-guides/stackpack/README.md)
    ...
    * [Rancher Observability Common Layer](develop/developer-guides/stackpack/stackstate-common-layer.md)
...
* [Reference](develop/reference/README.md)
  * [Rancher Observability OpenAPI docs](https://dl.stackstate.com/stackstate-openapi/v5.1/openapi-v5.1.0.html)
  * [Rancher Observability Markup Language \(STML\)](develop/reference/stml/README.md)
  ...
  * [Rancher Observability Scripting Language \(STSL\)](develop/reference/scripting/README.md)
    * [Scripting in Rancher Observability](develop/reference/scripting/scripting-in-stackstate.md)
  ...
  * [Rancher Observability templating](develop/reference/stackstate-templating/README.md)
    * [Using Rancher Observability templating](develop/reference/stackstate-templating/using_stackstate_templating.md)
...
* [Tutorials](develop/tutorials/README.md)
  ...
  * [Push data to Rancher Observability from an external system](develop/tutorials/push_integration_tutorial.md)
  * [Send events to Rancher Observability from an external system](develop/tutorials/events_tutorial.md)
