...
Metrics. OpenTelemetry authentication now also supports [Ingestion API Keys](https://docs.stackstate.com/security/k8s-ingestion-api-keys).
...
details, refer to the [documentation](https://docs.stackstate.com/agent/k8s-custom-secrets-setup).
