...
* **Restricted Scope Metrics:** Users with a restricted scope will now only have visibility into metrics collected after the platform upgrade. Historical metrics prior to the upgrade will not be accessible.
