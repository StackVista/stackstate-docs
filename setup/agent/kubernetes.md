...
2. No internet connection required:
   1. Transport images to the destination.
   ...
   2. Import images to the system, and optionally to a registry. 
      ...
      * Additional options when running the script:
        * `-p` - push images to the destination registry. When not specified, images will be imported to the registry and tagged, but but remain on the local machine.
