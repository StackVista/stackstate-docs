...
For the StackState SaaS product, the address of the StackState Receiver API is provided on the StackState UI StackPack page after a StackPack has been installed.
{% endtab %}
{% endtabs %}
