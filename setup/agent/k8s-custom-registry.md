...
This section describes how to copy the images used by the StackState Agent to another registry. The images are listed in the [Images](k8s-custom-registry.md#images) section.
