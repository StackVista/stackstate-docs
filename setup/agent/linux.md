...
2. Download the latest Agent installer package \(DEB or RPM package\) and copy this to the host where it will be installed. The download link can be constructed from the s3 bucket URL and the installer package `Key`  that is provided on the installer package list page. 
   ...
   * **DEB package**
      - Installer package list: [https://stackstate-agent-2.s3.amazonaws.com/?prefix=pool/stable/s/st/stackstate-agent_2.1](https://stackstate-agent-2.s3.amazonaws.com/?prefix=pool/stable/s/st/stackstate-agent_2.1)
      - Download link: `https://stackstate-agent-2.s3.amazonaws.com/<Key_from_installer_package_list>`
   * **RPM package**
      - Installer package list: [https://stackstate-agent-2-rpm.s3.amazonaws.com/?prefix=stable/stackstate-agent-2.1](https://stackstate-agent-2-rpm.s3.amazonaws.com/?prefix=stable/stackstate-agent-2.1)
      - Download link: `https://stackstate-agent-2-rpm.s3.amazonaws.com/<Key_from_installer_package_list>`
