...
Requirements for [StackState client (browser)](requirements.md#client-browser) can be found at the bottom of the page.
...
Optionally, a [non-high availability setup](kubernetes_openshift/non_high_availability_setup.md) can be configured which has the requirements listed below.
...
For more details on the defaults used, see the page [Configure storage](kubernetes_openshift/storage.md).
...
For more details on configuring Ingress, have a look at the page [Configure Ingress docs](kubernetes_openshift/ingress.md).
