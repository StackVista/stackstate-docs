...
### Changing the number of replicas for Longhorn persistent volumes
...
2. Select the required storage class in [Persistent volume settings](/setup/install-stackstate/kots-install/kots_configuration_screen.md#persistent-volume-settings) section of the KOTS Config UI.

3. Redeploy the application via KOTS Config UI.
