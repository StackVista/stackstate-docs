...
By default, StackState doesn't specify a storage class on its PVCs \(persistent volume claims\). For cloud providers, such as EKS and AKS, StackState uses the default storage class.
