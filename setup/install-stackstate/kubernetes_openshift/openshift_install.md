...
1. Before you deploy:
   ...
   * [Generate `values.yaml`](openshift_install.md#generate-values.yaml)
   * [Create `openshift-values.yaml`](openshift_install.md#create-openshift-values.yaml)
...
* [Create a `nonha_values.yaml` file](non_high_availability_setup.md)
