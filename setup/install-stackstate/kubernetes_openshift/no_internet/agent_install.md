...
2. [download the agent helm chart](agent_install.md#download-the-agent-helm-chart)
3. [copy the Agent docker images](agent_install.md#copy-agent-docker-images)
4. [customize the helm command](agent_install.md#customize-the-helm-command)
