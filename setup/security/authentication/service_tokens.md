...
Service tokens can be managed via the [new `sts` CLI](../../cli/k8sTs-cli-sts.md). The following commands are available:
...
It's also possible to [set up a bootstrap service token](service_tokens.md#set-up-a-bootstrap-service-token) when installing StackState.
...
* [Which version of the `sts` CLI am I running?](../../cli/cli-comparison.md#which-version-of-the-cli-am-i-running)
* New `sts` CLI: [Authentication](../../cli/cli-sts.md#authentication)
...
➡️ [Learn more about the StackState APIs](../../cli/cli-stac.md#authentication)
