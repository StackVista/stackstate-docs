...
{% hint style="info" %}
Note that The release notes on this page are for the Self-Hosted StackState product. As such, they may describe functionality that is not available in the StackState SaaS product. 
{% endhint %}
...
- The ability to create manual topology from the StackState UI was removed. Please use the Static Topology StackPack in order to create components manually. STAC-14377
