...
* The [default propagation function](/develop/developer-guides/custom-functions/propagation-functions.md#default-propagation-functions) is now called **Auto Propagation** and can be configured with one of the native propagation functions: **Auto** or **Transparent**.
