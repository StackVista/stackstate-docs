...
* Two new permissions have been added - `manage-event-handlers` and `execute-restricted-scripts`. For details, see [RBAC permissions](/configure/security/rbac/rbac_permissions.md):
