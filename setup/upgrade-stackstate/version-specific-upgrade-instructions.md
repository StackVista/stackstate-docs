...
#### v5.1.0
* The node sizing requirements for deploying the StackState platform have changed. Check the [requirements to deploy StackState on Kubernetes or OpenShift](/setup/install-stackstate/requirements.md#node-sizing).
